        ...
        <div class="row">
          <div class="col-md-6">
            <div class="small-box bg-yellow">
              <div class="inner">
                <h3>{{$user}}</h3>
                <p>{{ trans('backLang.TotalStudents') }}</p>
              </div>
              <div class="icon">
          ...
          <div class="col-md-6">
            <div class="small-box bg-red">
              <div class="inner">
                <h3>{{$quiz}}</h3>
                <p>{{ trans('backLang.TotalQuiz') }}</p>
              </div>
              <div class="icon">
                <i class="fa fa-question-circle-o"></i>
              </div>
              <a href="{{url('/admin/topics')}}" class="small-box-footer">
                {{ trans('backLang.Moreinfo') }} <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-md-6">
            <div class="small-box bg-green">
              <div class="inner">
                <h3>{{$question}}</h3>
                <p>{{ trans('backLang.TotalQuestions') }}</p>
              </div>
              <div class="icon">
                <i class="fa fa-question-circle-o"></i>
              </div>
            ...
            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#AllDeleteModal">{{ trans('backLang.ClearAllAnswerSheets') }}</button>
            <!-- All Delete Button -->
      ...
      <div class="col-md-5">
        <div class="box box-danger">
          <div class="box-header with-border">
            <h4 class="box-title">{{ @trans('backLang.LatestStudents') }}</h4>
          ...
          <div class="box-footer text-center">
            <a href="{{url('admin/users')}}" class="uppercase">{{ @trans('backLang.ViewAllStudents') }}</a>
          </div>
          <!-- /.box-footer -->
        </div>
      </div>
