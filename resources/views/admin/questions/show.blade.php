@extends('layouts.admin', [
  'page_header' => "Danh sách đề thi / {$topic->title} ",
  'dash' => '',
  'quiz' => '',
  'users' => '',
  'questions' => 'active',
...
@section('content')
  <div class="margin-bottom">
    <button type="button" class="btn btn-wave" data-toggle="modal" data-target="#createModal">Thêm Câu hỏi</button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Tạo câu hỏi</h4>
        </div>
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="form-group{{ $errors->has('question') ? ' has-error' : '' }}">
                  ...
                  {!! Form::textarea('question', null, ['class' => 'form-control', 'rows'=>'12', 'required' => 'required']) !!}
                  <small class="text-danger">{{ $errors->first('question') }}</small>
                </div>
                {{--  <div class="form-group{{ $errors->has('answer') ? ' has-error' : '' }}">
                    {!! Form::label('answer', 'Đáp án đúng') !!}
              ...
              <div class="col-md-4">
                <div class="form-group{{ $errors->has('a') ? ' has-error' : '' }}">
                  {!! Form::label('a', 'Đáp án A') !!}
                  {!! Form::text('a', null, ['class' => 'form-control', 'required' => 'required']) !!}
                  <small class="text-danger">{{ $errors->first('a') }}</small>
                </div>
                <div class="form-group{{ $errors->has('b') ? ' has-error' : '' }}">
                  {!! Form::label('b', 'Đáp án B') !!}
                ...
                <div class="form-group{{ $errors->has('c') ? ' has-error' : '' }}">
                  {!! Form::label('c', 'Đáp án C') !!}
                  {!! Form::text('c', null, ['class' => 'form-control', 'required' => 'required']) !!}
                  <small class="text-danger">{{ $errors->first('c') }}</small>
                </div>
                <div class="form-group{{ $errors->has('d') ? ' has-error' : '' }}">
                  {!! Form::label('d', 'Đáp án D') !!}
                  {!! Form::text('d', null, ['class' => 'form-control', 'required' => 'required']) !!}
              ...
              <div class="col-md-4">
                {{--  <div class="form-group{{ $errors->has('code_snippet') ? ' has-error' : '' }}">
                    ...
                    {!! Form::textarea('code_snippet', null, ['class' => 'form-control', 'rows' => '5']) !!}
                ...
                <div class="form-group{{ $errors->has('answer_ex') ? ' has-error' : '' }}">
                    {!! Form::label('answer_ex', 'Giải thích đáp án') !!}
                    {!! Form::textarea('answer_ex', null, ['class' => 'form-control', 'rows' => '8']) !!}
                    <small class="text-danger">{{ $errors->first('answer_ex') }}</small>
                </div>
              </div>
              <div class="col-md-12">
                <div class="extras-block">
                  {{--  <h4 class="extras-heading">Extras</h4>  --}}
                  <div class="row">
                    {{--  <div class="col-md-6">
  ...
  <div id="importQuestions" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Import Questions (Excel File With Exect Header Of DB Field)</h4>
        </div>
          ...
          <div class="modal-body">
            ...
            <div class="form-group{{ $errors->has('question_file') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-9">
                ...
                <p class="help-block">Only Excel File</p>
                          ...
                          <div class="col-md-12">
                            <div class="extras-block">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group{{ $errors->has('question_img') ? ' has-error' : '' }}">
                                    {!! Form::label('question_img', 'Hình ảnh') !!}
                                    {!! Form::file('question_img') !!}
                                    <small class="text-danger">{{ $errors->first('question_img') }}</small>
                                  </div>
                                </div>
